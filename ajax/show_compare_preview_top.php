...
$APPLICATION->IncludeComponent(
	...
	array(
		...
		"IBLOCK_ID" => \Bitrix\Main\Config\Option::get("aspro.allcorp3", "CATALOG_IBLOCK_ID", "#CATALOG_IBLOCK_ID#"),
		"AJAX_MODE" => "N",
		"AJAX_OPTION_JUMP" => "N",
		"AJAX_OPTION_STYLE" => "Y",
		"AJAX_OPTION_HISTORY" => "N",
		"DETAIL_URL" => "/catalog/#SECTION_CODE_PATH#/#ELEMENT_ID#/",
		"COMPARE_URL" => str_replace('/', SITE_DIR, CAllcorp3::GetFrontParametrValue("COMPARE_PAGE_URL")),
