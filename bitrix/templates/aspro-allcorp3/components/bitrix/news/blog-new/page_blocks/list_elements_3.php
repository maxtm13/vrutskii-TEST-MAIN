...
if($arParams['SECTION_ELEMENTS_TYPE_VIEW'] === 'FROM_MODULE'){
	$blockTemplateOptions = $GLOBALS['arTheme']['BLOG_PAGE']['LIST'][$GLOBALS['arTheme']['BLOG_PAGE']['VALUE']];
	$bItemsOffset = $blockTemplateOptions['ADDITIONAL_OPTIONS']['ELEMENTS_OFFSET_BLOG']['VALUE'] === 'Y';
	$imagePosition = $blockTemplateOptions['ADDITIONAL_OPTIONS']['ELEMENTS_IMAGE_POSITION_BLOG']['VALUE'];
}
else{
