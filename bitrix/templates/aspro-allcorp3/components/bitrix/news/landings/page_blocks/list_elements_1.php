...
if($arParams['SECTION_ELEMENTS_TYPE_VIEW'] === 'FROM_MODULE'){
	$blockTemplateOptions = $GLOBALS['arTheme']['LANDINGS_PAGE']['LIST'][$GLOBALS['arTheme']['LANDINGS_PAGE']['VALUE']];
	$bItemsOffset = $blockTemplateOptions['ADDITIONAL_OPTIONS']['ELEMENTS_OFFSET_LANDING']['VALUE'] === 'Y';
	$imagePosition = $blockTemplateOptions['ADDITIONAL_OPTIONS']['ELEMENTS_IMAGE_POSITION_LANDING']['VALUE'];
}
else{
