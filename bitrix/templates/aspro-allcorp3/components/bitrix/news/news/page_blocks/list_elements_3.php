...
if($arParams['SECTION_ELEMENTS_TYPE_VIEW'] === 'FROM_MODULE'){
	$blockTemplateOptions = $GLOBALS['arTheme']['NEWS_PAGE']['LIST'][$GLOBALS['arTheme']['NEWS_PAGE']['VALUE']];
	$bItemsOffset = $blockTemplateOptions['ADDITIONAL_OPTIONS']['ELEMENTS_OFFSET_NEWS']['VALUE'] === 'Y';
	$imagePosition = $blockTemplateOptions['ADDITIONAL_OPTIONS']['ELEMENTS_IMAGE_POSITION_NEWS']['VALUE'];
}
else{
