...
if($arParams['SECTIONS_TYPE_VIEW'] === 'FROM_MODULE'){
	$blockTemplateOptions = $GLOBALS['arTheme']['SECTIONS_TYPE_VIEW_TARIFFS']['LIST'][$GLOBALS['arTheme']['SECTIONS_TYPE_VIEW_TARIFFS']['VALUE']];
	$bItemsOffset = $blockTemplateOptions['ADDITIONAL_OPTIONS']['SECTIONS_ITEMS_OFFSET_TARIFFS']['VALUE'] === 'Y';
	$elementsCount = $blockTemplateOptions['ADDITIONAL_OPTIONS']['SECTIONS_ELEMENTS_COUNT_TARIFFS']['VALUE'];
	$images = $blockTemplateOptions['ADDITIONAL_OPTIONS']['SECTIONS_IMAGES_TARIFFS']['VALUE'];
	$imagePosition = $blockTemplateOptions['ADDITIONAL_OPTIONS']['SECTIONS_IMAGE_POSITION_TARIFFS']['VALUE'];
}
else{
