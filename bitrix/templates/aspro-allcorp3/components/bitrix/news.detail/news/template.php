...
<?ob_start();?>
	<div class="btn btn-default btn-wide btn-lg <?=($bOrderButton && $bAskButton) ? 'btn-transparent-border' : '';?> animate-load" data-event="jqm" data-param-id="<?=CAllcorp3::getFormID("aspro_allcorp3_question");?>" data-autoload-need_product="<?=CAllcorp3::formatJsName($arResult['NAME'])?>" data-name="question">
...
<?ob_start();?>
	...
	data-event="jqm" 
	data-param-id="<?=CAllcorp3::getFormID($arParams['FORM_ID_ORDER_SERVISE']);?>" data-autoload-need_product="<?=CAllcorp3::formatJsName($arResult['NAME'])?>" 
			...
			<?if ($bSaleNumber || $bDiscountCounter):?>
				<div class="line-block__item">
					<div class="line-block line-block--8 line-block--16-vertical line-block--flex-wrap">
						...
						<?endif;?>
						<?if ($bDiscountCounter):?>
							<?\Aspro\Functions\CAsproAllcorp3::showDiscountCounter([
								'WRAPPER' => true,
