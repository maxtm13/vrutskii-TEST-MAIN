...
<?$arShop=\Aspro\Functions\CAsproAllcorp3::prepareShopListArray($templateData['MAP_ITEMS'], $arParams);?>
...
<?if($templateData['MAP_ITEMS']):?>
	...
	<div class="map-view bordered<?=($bNarrow ? '' : ' map-view--long');?>">
			...
			<?if($arParams["MAP_TYPE"] == 1):?>
				<?$APPLICATION->IncludeComponent(
					...
					array(
						...
						"MAP_DATA" => serialize(array("google_lat" => $arShop["POINTS"]["LON"], "google_lon" => $arShop["POINTS"]["LAT"], "google_scale" => 16, "PLACEMARKS" => $arShop["PLACEMARKS"])),
						"MAP_WIDTH" => "100%",
						"MAP_HEIGHT" => ($bNarrow ? 520 : 650),
						"CONTROLS" => array(
