...
$blockOptions = $indexPageOptions['PROJECTS'];
...
<?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"RIGHT_LINK" => "/projects/",
		"COMPONENT_TEMPLATE" => "project-list-new",
		"SET_LAST_MODIFIED" => "N",
		...
		"SHOW_PREVIEW_TEXT" => "Y",
		"SHOW_SECTION_NAME" => "Y",
		"NAME_SIZE" => ($blockTemplateOptions["ADDITIONAL_OPTIONS"]["ELEMENTS_COUNT"]["VALUE"]==2?22:18),
		...
		"CHECK_REQUEST_BLOCK" => CAllcorp3::checkRequestBlock("projects"),
