...
<div class="bx_profile">
	...
	?>
    <pre>
        <?print_r($arResult["arUser"]["UF_PASSPORT_NUMBER"]);?>
	...
	<form method="post" name="form1" action="<?=POST_FORM_ACTION_URI?>" enctype="multipart/form-data" role="form">
		...
		<div class="main-profile-block-shown" id="user_div_reg">
            ...
            <div class="form-group">
                <label class="main-profile-form-label col-sm-12 col-md-3 text-md-right" for="main-profile-passport">Паспорт</label>
                <div class="col-sm-12">
                    <input class="form-control" type="text" name="passpoer" maxlength="50" id="main-profile-passport" value="<?=$arResult["arUser"]["UF_PASSPORT_NUMBER"]?>" />
                </div>
            </div>
			<?
